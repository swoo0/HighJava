...
public class T06_Set {
	public static void main(String[] args) {
		...
		System.out.println("K(포함)부터 N(미포함)까지 : " + ts.subSet("K", false, "N", false));
