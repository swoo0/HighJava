...
public class T01_Enum {
/*
	enum 은 상수(final)의 단점을 보완하기 위해 나왔다.
	구조가 class 와 비슷하다.
		
	static final A int = 0;
	static final B int = 1;
	static final C int = 2;
	static final D int = 3;
...
*/	 
	...
	// City 열거형의 객체 선언(기본값을 이용하는 열거형) 
	public enum City { 서울, 부산, 대구, 광주, 대전 };
	
	// 데이터 값을 임의로 지정한 열거형 객체 선언
	// 데이터 값을 정해 줄 경우에는 생성자를 만들어서 괄호속이 값이
	// 변수에 저장되도록 해야 한다.
	public enum Season {
