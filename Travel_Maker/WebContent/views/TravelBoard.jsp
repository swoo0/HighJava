...
<script type="text/javascript" src="../js/travelboard.js"></script>
		...
		<div id="myModal" class="modal fade" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<h4 class="modal-title">여행리뷰 글쓰기</h4>
						<button type="button" class="close" data-dismiss="modal">&times;</button>
					</div>
					<div class="modal-body">

						<!-- 요기 인풋타입에 클래스 주면 글작성 못하니까 주의 css 줄 꺼면 차라리 아이디 주는게 나을 듯 -->
						<form action="/Travel_Maker/TravelBoardInsert.do" method="post" enctype="multipart/form-data">
							
							<label>제목</label>
							<br>  
							<input type="text" name="tm_b_title" ><br>
							<br>
							 
							<label>내용</label>
							<br> 
							<textarea rows="15" cols="45" name="tm_b_content"></textarea>
