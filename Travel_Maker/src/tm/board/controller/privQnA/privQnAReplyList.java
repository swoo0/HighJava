 ...
 */
@WebServlet("/privQnAReplyList.do")
public class privQnAReplyList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public privQnAReplyList() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//4
		request.getRequestDispatcher("/WEB-INF//views/privQnA/privQnAreplyList.jsp").forward(request, response);
