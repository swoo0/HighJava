 ...
 */
@WebServlet("/ScrapInsert.do")
public class ScrapInsert extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!tm_id.equals("비회원")) {
			...
			cnt = service.insertScrap(vo);
		}
		 request.setAttribute("cnt", cnt);
		 request.getRequestDispatcher("WEB-INF/views/SearchModal/ScrapResult.jsp").forward(request, response);
