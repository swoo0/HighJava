...
/**
 * Servlet implementation class CancelLike
 */
@WebServlet("/SearchLikeCancel.do")
public class SearchLikeCancel extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("취소 세션아이디 : " + tm_id);		
		
		
		String tm_search_id = request.getParameter("tm_search_id");
		System.out.println("취소 서치아이디 : " + tm_search_id);
		...
		int cnt = service.cancelSearchLike(vo);
